...
import com.ugps.curso.entities.Payment;
import com.ugps.curso.entities.Product;
import com.ugps.curso.entities.User;
import com.ugps.curso.entities.enums.OrderStatus;
import com.ugps.curso.repositories.CategoryRepository;
import com.ugps.curso.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired
	private OrderRepository orderRepository; //esse é o objeto que acessa os dados
	
	@Autowired
	private CategoryRepository categoryRepository; //esse é o objeto que acessa os dados
	
	@Autowired
	private ProductRepository productRepository; //esse é o objeto que acessa os dados
	
	@Autowired
	private OrderItemRepository orderItemRepository; //esse é o objeto que acessa os dados
	...
	//tudo aqui dentro será iniciado quando o programa rodar
		...
		//aqui estou associando os produtos com as categorias deles na lista Set
