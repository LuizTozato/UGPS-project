...
import com.ugps.curso.services.UserService;
...
public class UserResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<User> findById(@PathVariable Long id){ //para o spring aceitar o id, tenho que declarar o PathVariable 
